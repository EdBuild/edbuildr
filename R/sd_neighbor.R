#' @title A function to create a dataframe of a school district and all its
#'   neighbors
#' @name sd_neighbor
#' @description This function allows you to create a table to view any school
...
#' @import dplyr scales stringr magrittr
#' @usage sd_neighbor(data_year = "2018", school_district = NULL, table_vars =
...
#' @seealso \code{\link{sd_neighbor_xlsx}}, \code{\link{sd_table_xlsx}},
...
sd_neighbor = function (data_year = "2018", school_district = NULL, table_vars = c('Name', 'Enrollment', 'Poverty Rate', 'Percent Nonwhite', 'Local Revenue PP', 'State Revenue PP', 'Type')) {
