...
#' @usage sd_table_xlsx(data_year = '2017', state = "New Jersey", county = NULL,
...
#' @export
#' @examples
#' \donttest{my_table <- sd_table_xlsx(data_year = "2017",
#'             state = "Maryland",
...
sd_table_xlsx = function (data_year = '2017', state = "New Jersey", county = NULL, table_vars = c('Name', 'Enrollment', 'Poverty Rate', 'Percent Nonwhite', 'Local Revenue PP', 'State Revenue PP', 'Total Revenue PP')) {

  good <- c('NCESID', 'Name', 'County', 'Enrollment', 'Poverty Rate', 'Percent Nonwhite', 'Percent FRL',
            'Local Revenue PP', 'State Revenue PP', 'Total Revenue PP',
            'MPV', 'MHI')

  county_name <- masterpull(data_year='2017', data_type = "fin") %>%
