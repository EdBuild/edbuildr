...
#' @usage sd_neighbor_xlsx(data_year = "2019", school_district = NULL,
...
sd_neighbor_xlsx = function (data_year = "2019", school_district = NULL, table_vars = c('Name', 'Enrollment', 'Poverty Rate', 'Percent Nonwhite', 'Local Revenue PP', 'State Revenue PP', 'Type')) {
