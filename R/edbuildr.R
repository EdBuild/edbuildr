...
#'details. The master dataset is available for any school year from 2013 to 2018 or
#'longitudinally for all years 2013-2018. School year is identified by the end year.
#'For example, the 2017-18 school year is 2018. Additional functions in the package use
...
#'  adjustments. Available for 2006-2018.}
...
#'  Available for 1990-2018.} \item{\code{\link{long_masterpull}}}{Pulls in
#'  EdBuild's master dataset longitudinally for years 2013-2018.}
...
#'  were calculated using C2ER. Available for 2013-2018.}
