...
#' @usage f33pull(data_year = "2019", path=NULL, additional_var=NULL, keep_calcs=FALSE)
...
#'
#' @examples
#' \donttest{f33_2019 <- f33pull(data_year="2019",
#'                     additional_var=c("V40", "TCAPOUT"),
#'                     keep_calcs=FALSE)}


f33pull = function(data_year = "2019", path=NULL, additional_var=NULL, keep_calcs=FALSE) {
  ...
  if (as.numeric(data_year)<2006) {
    ...
    #the most current year of F33 data is 2019, so a data_year of more than that is not valid
